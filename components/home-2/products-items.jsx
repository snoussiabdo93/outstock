              ...
              <div key={prd.id} className="product__banner-inner p-absolute fix d-none d-lg-block">
                <div className="product__banner-img">
                  <Link href={`/product-details/${prd.id}`}>
                    <a>
                      <Image width='100%' height='100%' src={prd.img} alt="product-banner" />
                    </a>
                  </Link>
                </div>
                                ...
                                <div key={index} className="product__wrapper mb-60">
                                  <div className="product__thumb">
                                    <Link href={`/product-details/${product.id}`}>
                                      <a className="w-img">
                                        <Image width='100%' height='100%' src={product.img} alt="product-img" />
                                        {product.thumb_img &&
                                          <Image width='100%' height='100%' className="product__thumb-2" src={product.thumb_img} alt="product-img" />
                                        }
                                      </a>
                                    </Link>
