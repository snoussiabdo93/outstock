            ...
            <div className="col-xl-9 col-lg-8">
              ...
              <div className="postbox__wrapper mb-70">
                ...
                <div className="postbox__details-img w-img mb-60">
                  <Image width='100%' height='100%' src="/assets/img/blog/blog-details-sm.jpg" alt="" />
                </div>
                <div className="postbox__text">
                      ...
                      <div className="blog__item mb-30">
                        <div className="blog__thumb fix">
                          <Link href={`/blog-details/${blog.id}`}>
                            <a className="w-img">
                              <Image width='100%' height='100%' src={blog.img} alt="blog" />
                            </a>
                          </Link>
                        </div>
                      ...
                      <li key={index} className={review.children ? 'children' : ''}>
                        <div className="comments-box">
                          <div className="comments-avatar">
                            <Image width='100%' height='100%' src={review.img} alt="" />
                          </div>
