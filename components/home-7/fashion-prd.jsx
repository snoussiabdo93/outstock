          ...
          <div className="product__wrapper">
            <div className="product__thumb">
              <Link href={`/product-details/${prd.id}`}>
                <a className="w-img">
                  <Image width='100%' height='100%' src={prd.img} alt="product-img" />
                  <Image width='100%' height='100%' className="product__thumb-2" src={prd.thumb_img} alt="product-img" />
                </a>
              </Link>
  ...
  return (
    <div className="product__big-image effectThree mb-40">
      <Link href={`/product-details/${fashion_big_prd[prdNumber].id}`}>
        <a>
          <Image width='100%' height='100%' src={fashion_big_prd[prdNumber].img} alt="" />
        </a>
      </Link>
    </div>
  )
